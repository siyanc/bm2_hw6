...
crab_df = read.delim("/Users/siyanchen/Desktop/data/HW5-crab copy.txt", header = TRUE, sep = "")
```
...
```{r}
par_df = read.delim("/Users/siyanchen/Desktop/data/HW5-parasite.txt", header = TRUE, sep = "") %>% 
